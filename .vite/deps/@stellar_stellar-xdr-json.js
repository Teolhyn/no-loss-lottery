...
// node_modules/@stellar/stellar-xdr-json/stellar_xdr_json.js
var wasm;
...
function decode_stream(type_variant, xdr_base64) {
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
    const ptr0 = passStringToWasm0(type_variant, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
    const len0 = WASM_VECTOR_LEN;
...
function decode(type_variant, xdr_base64) {
  let deferred4_0;
  let deferred4_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function encode(type_variant, json) {
  let deferred4_0;
  let deferred4_1;
  try {
    const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
var stellar_xdr_json_default = __wbg_init;
export {
  decode,
  decode_stream,
  stellar_xdr_json_default as default,
  encode,
  guess,
  initSync,
  schema,
...
//# sourceMappingURL=@stellar_stellar-xdr-json.js.map
